SELECT
    ...
    "当天活跃玩家数",
    "battle_type=21人均次数",
    "battle_type=21玩家最大次数",
    "battle_type=21玩家最小次数",
    "人均在线时长_分钟",
    "玩家最大在线时长_分钟",
    "玩家最小在线时长_分钟"
    ...
    (
        ...
        (
            SELECT
                ...
                max(
                    CASE
                        WHEN event_e."$part_event" = 'ta_app_end'
                            THEN 1
                        ELSE 0
                    END
                ) AS is_active,
                ...
                sum(
                    CASE
                        WHEN event_e."$part_event" = 'battle_start'
                             AND try_cast(
                                    event_e."battle_type"
                                    AS bigint
                                 ) = 21
